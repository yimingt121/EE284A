...
t_u, v_u, i_u, p_u = load("sunlight.csv")
summary("Sunlight", t_u, v_u, i_u, p_u)

try:
    t_p, v_p, i_p, p_p = load("shade.csv")
    summary("Shade",   t_p, v_p, i_p, p_p)
except FileNotFoundError:
    pass

t_u, v_u, i_u, p_u = load("indoor_light.csv")
summary("Indoor light", t_u, v_u, i_u, p_u)


t_u, v_u, i_u, p_u = load("nopanel.csv")
summary("No solar panel", t_u, v_u, i_u, p_u)
